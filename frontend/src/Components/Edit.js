...
const Edit = ({ getData, handleModalClose, item, editData }) => {
  ...
  return (
    <Form style={style} onSubmit={handleSubmit}>
      ...
      <Lower>
        ...
        />
        <InputField
          defaultValue={editData?.leadStudio}
          placeholder="Lead Studio"
          name="leadStudio"
          required
        />
        <InputField
          ...
          name="audienceScore"
          required
          defaultValue={editData?.audienceScore}
        />
        <InputField
          defaultValue={editData?.profitibity}
          placeholder="Profibility"
          name="profitibity"
          required
        />
        <InputField
          ...
          name="rottenTomato"
          defaultValue={editData?.rottenTomato}
          required
        />
        <InputField
          placeholder="World Wide Gross $"
          name="worldWideGross"
          defaultValue={editData?.worldWideGross}
          required
        />
        <InputField
          placeholder="Year"
